...
class LLMConfig(BaseSettings):
    ...
    llm_model: str = Field(
        ...
        description="Model name specific to the provider"
    )
    ...
    azure_api_base: Optional[str] = Field(default=None, description="Azure API base URL")
    azure_api_version: Optional[str] = Field(default=None, description="Azure API version")
    ...
    output_log_dir: Path = Field(
        default=Path("src/log"),
        description="Directory for diagnostic logs"
    )
    
    @field_validator("output_markdown_dir", "output_json_dir", "output_log_dir", mode="before")
    @classmethod
